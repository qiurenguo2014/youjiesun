...
#define LCD_BASE_emwin					0X60000000//價華硊
#define LCD_REG_ADDRESS					*(volatile U16*)LCD_BASE_emwin		//LCD敵湔ん華硊
#define LCD_RAM_ADDRESS					*(volatile U16*)(LCD_BASE_emwin + 0x40000)	//LCD RAM華硊
/*********************************************************************
*
