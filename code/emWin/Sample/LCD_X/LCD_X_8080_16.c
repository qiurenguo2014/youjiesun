...
#define LCD_BASE_emwin					0X60000000//基地址
#define LCD_REG_ADDRESS					*(volatile U16*)LCD_BASE_emwin		//LCD寄存器地址
#define LCD_RAM_ADDRESS					*(volatile U16*)(LCD_BASE_emwin + 0x40000)	//LCD RAM地址
/*********************************************************************
*
